...
export default function Login() {
  ...
  return (
    <div style={{ position: "relative", minHeight: "100vh", display: "flex", justifyContent: "center", alignItems: "center", overflow: "hidden", fontFamily: "'Inter', sans-serif" }}>
      ...
      >
        <h2 style={{ textAlign: "center", marginBottom: "8px", fontWeight: 700, fontSize: "1.8rem", letterSpacing: "-0.5px" }}>Welcome</h2>
        <p style={{ textAlign: "center", color: "#b3b3c1", marginBottom: "30px", fontSize: "0.9rem" }}>Sign in to continue to T-Stream</p>
